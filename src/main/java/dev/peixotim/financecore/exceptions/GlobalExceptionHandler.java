...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleNotFound(HttpClientErrorException.NotFound ex, WebRequest request) {
    ...
    public ResponseEntity<?> handleConflict(HttpClientErrorException.Conflict ex, WebRequest request) {
